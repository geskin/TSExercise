...
let highScore // no types yet, add types and initialize //
...
const stuff: // no types yet, add types and initialize //
...
type SkillLevel = "Beginner" // how can we add the other types ?
